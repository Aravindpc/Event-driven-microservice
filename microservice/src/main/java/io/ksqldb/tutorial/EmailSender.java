...
public class EmailSender {
    ...
    private final static String FROM_EMAIL = "aravindpc";
    // For you to fill in: the SendGrid API key to use their service.
    private final static String SENDGRID_API_KEY = "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";
